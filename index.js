...
module.exports = {
  sdk: function ({
    mode = "development", privateKey, publicKey, globalSiteId, globalSiteName
  }) {
    ...
    * @return {Promise}
    */
    this.healthCheck = () => new Promise((resolve, reject) => {
      axios({
        method: "get",
    ...
    * @return {Promise}
    */
    this.removeCustomerCard = cardToken => new Promise((resolve, reject) => {
    ...
    * @return {Promise}
    */
    this.getCustomerCardList = userId => new Promise((resolve, reject) => {
    ...
    * @return {Promise}
    */
    this.singleSplitPayment = capturePayment => new Promise((resolve, reject) => {
      const {
        siteTransactionId,
        cardToken,
        userId,
      ...
      const platformAmount = Number((amount - vendorAmount).toFixed(2))
      // Add platform charge
    ...
    * @return {Promise}
    */
    this.payment = capturePayment => new Promise((resolve, reject) => {
      const {
        siteTransactionId,
        cardToken,
        userId,
    ...
    * @return {Promise}
    */
    this.getPayments = filter => new Promise((resolve, reject) => {
      const {
        offset = 0,
        pageSize = 20,
        siteOperationId,
    ...
    * @return {Promise}
    */
    this.paymentRefund = (paymentId, amount = null) => new Promise((resolve, reject) => {
